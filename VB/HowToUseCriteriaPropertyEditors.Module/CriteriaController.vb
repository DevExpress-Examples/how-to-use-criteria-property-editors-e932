...
Namespace HowToUseCriteriaPropertyEditors.Module
    Public Class CriteriaController
        ...
        Private Sub FilteringCriterionAction_Execute(ByVal sender As Object, ByVal e As SingleChoiceActionExecuteEventArgs)
            ...
            CType(View, ListView).CollectionSource.Criteria(e.SelectedChoiceActionItem.Caption) = _
                CriteriaEditorHelper.GetCriteriaOperator(TryCast(e.SelectedChoiceActionItem.Data, String), View.ObjectTypeInfo.Type, ObjectSpace)
