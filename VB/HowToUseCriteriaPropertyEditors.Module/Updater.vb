	...
	Public Class Updater
		...
		Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
			...
			If sampleCriterion5 Is Nothing Then
                ...
                sampleCriterion5.Criterion = "[Manager] = '@ObjectType:" & samplePerson1.GetType().ToString() + "@ObjectID:" & samplePerson1.Oid.ToString() & "'"
			...
			If sampleCriterion6 Is Nothing Then
                ...
                sampleCriterion6.Criterion = "[Manager] = '@ObjectType:" & samplePerson2.GetType().ToString() & "@ObjectID:" & samplePerson2.Oid.ToString() & "'"
