...
Namespace HowToUseCriteriaPropertyEditors.Module
    Public Class Updater
        ...
        Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
            ...
            Dim samplePerson1 As Person = Session.FindObject(Of Person)(CriteriaOperator.Parse("FullName == 'Mary Tellitson'"))
            If samplePerson1 Is Nothing Then
                ...
                samplePerson1.Save()
            End If
            Dim samplePerson2 As Person = Session.FindObject(Of Person)(CriteriaOperator.Parse("FullName == 'John Nilsen'"))
            If samplePerson2 Is Nothing Then
                ...
                samplePerson2.Save()
            End If
            Dim sampleProduct1 As Product = Session.FindObject(Of Product)(CriteriaOperator.Parse("Name == 'Geitost'"))
            ...
            End If
            Dim sampleCriterion5 As FilteringCriterion = Session.FindObject(Of FilteringCriterion)(CriteriaOperator.Parse("Description == 'Manager is Mary Tellitson'"))
            If sampleCriterion5 Is Nothing Then
                ...
                sampleCriterion5.Criterion = "[Manager] = '@ObjectType:" & _
                samplePerson1.GetType().ToString() & "@ObjectID:" & samplePerson1.Oid.ToString & "'"
                sampleCriterion5.Save()
            End If
            Dim sampleCriterion6 As FilteringCriterion = Session.FindObject(Of FilteringCriterion)(CriteriaOperator.Parse("Description == 'Manager is John Nilsen'"))
            If sampleCriterion6 Is Nothing Then
                ...
                sampleCriterion6.Criterion = "[Manager] = '@ObjectType:" & _
                samplePerson2.GetType().ToString() & "@ObjectID:" & samplePerson2.Oid.ToString & "'"
