...
Namespace HowToUseCriteriaPropertyEditors.Module
    ...
    Public Class FilteringCriterion
        ...
        Public Property Description() As String
            ...
            End Set
        End Property
        <ValueConverter(GetType(TypeToStringConverter)), ImmediatePostData, TypeConverter(GetType(LocalizedClassInfoTypeConverter))>
        Public Property ObjectType() As Type
            ...
            End Set
        End Property
        <CriteriaOptions("ObjectType"), Size(SizeAttribute.Unlimited), EditorAlias(EditorAliases.PopupCriteriaPropertyEditor)>
